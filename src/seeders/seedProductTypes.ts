...
const PRODUCT_TYPES = [
  {
    ...
    creatifyPrompt: 'Warm, friendly, and celebratory tone. Bright and cheerful setting. Natural smiling expression with genuine emotion. Soft, flattering lighting. Avoid: formal or stiff posture, dark or moody lighting, serious expression, corporate aesthetic.',
  ...
  },
  {
    ...
    creatifyPrompt: 'Maintain a calm, authoritative, and professional manner. Smiling, friendly expression. Subtle eyebrow raise on key statements, natural hand movements. Keep natural breathing inhale exhale cycle, visible between speech. Avoid: cartoon, illustration, anime, painting, oversmooth skin, plastic skin, unrealistic face, distorted eyes, extra fingers, blur, low resolution, bad anatomy, artificial lighting, waxy skin.',
  ...
  },
  {
    ...
    creatifyPrompt: 'Full-body natural motion, high production value, cinematic quality. Confident posture, natural movement, dynamic presence. Premium lighting setup, crisp detail throughout the full body frame. Avoid: partial body shots, unnatural stiff movement, low resolution, overexposed lighting, motion blur, distorted proportions, cropped limbs.',
